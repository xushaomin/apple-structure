...
import com.appleframework.structure.rtree.PriorityQueue;
...
public class RTree implements SpatialIndex, Serializable {
  ...
  /**
   * @see com.appleframework.structure.rtree.SpatialIndex#nearest(Point, TIntProcedure, double)
   */
  ...
  private void createNearestNDistanceQueue(Point p, int count, PriorityQueue distanceQueue, double furthestDistance) {
  ...
  /**
   * @see com.appleframework.structure.rtree.SpatialIndex#nearestNUnsorted(Point, TIntProcedure, int, double)
   */
  ...
  /**
   * @see com.appleframework.structure.rtree.SpatialIndex#nearestN(Point, TIntProcedure, int, double)
   */
  ...
  /**
   * @see com.appleframework.structure.rtree.SpatialIndex#intersects(Rectangle, TIntProcedure)
   */
  ...
  /**
   * @see com.appleframework.structure.rtree.SpatialIndex#contains(Rectangle, TIntProcedure)
   */
  ...
  private Node splitNode(Node n, double newRectMinX, double newRectMinY, double newRectMaxX, double newRectMaxY, int newId) {
    ...
    // debug code
    if (log.isDebugEnabled()) {
      double newArea = Rectangle.area(n.mbrMinX, n.mbrMinY, n.mbrMaxX, n.mbrMaxY) +
