 ...
 * 
 * <p>
 * All of the search methods, ie nearest(), contains() and intersects(), run in
 * linear time, so performance will be very slow with more than 1000 or so
 * entries.
 * </p>
 * 
 * <p>
...
public class SimpleIndex implements SpatialIndex {
	...
	/**
	 * @see com.appleframework.structure.rtree.SpatialIndex#nearest(Point, gnu.trove.TIntProcedure,
	 *      double)
	 */
	...
	private TIntArrayList nearestN(Point p, int n, double furthestDistance) {
		...
		while (iter.hasNext()) {
			...
			if (distance <= furthestDistance) {
				...
				if (ids.size() > n) {
					// check that removing all entries with equal greatest
					// distance
	...
	/**
	 * @see com.appleframework.structure.rtree.SpatialIndex#nearestN(Point, gnu.trove.TIntProcedure,
	 *      int, double)
	 */
	 ...
	 * Same as nearestN
	 * 
	 * @see com.appleframework.structure.rtree.SpatialIndex#nearestNUnsorted(Point,
	 *      gnu.trove.TIntProcedure, int, double)
	 */
	...
	/**
	 * @see com.appleframework.structure.rtree.SpatialIndex#intersects(Rectangle,
